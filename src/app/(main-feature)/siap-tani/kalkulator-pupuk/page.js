      ...
      <div className="container">
        ...
        <div className="flex flex-row">
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div className="grid grid-cols-3 gap-3">
                  <div>
                    ...
                    <input
                      ...
                      value={jumlahBedeng}
                      onChange={(e) => setJumlahBedeng(Number(e.target.value))}
                    />
                  </div>
                  <div>
                    <label
                    ...
                    <input
                      ...
                      className="w-full p-2 mb-4 border border-gray-300 rounded-md"
                      value={panjangRerata}
                      onChange={(e) => setPanjangRerata(Number(e.target.value))}
                    />
                  </div>
                  <div>
                    <label
              ...
              <div className="grid grid-cols-1">
                ...
                <select
                  ...
                  name="land"
                  className="border border-gray-300 rounded-md py-2"
                  value={selectedLandOption}
                  onChange={(e) =>
                    setSelectedLandOption(Number(e.target.value))
                  }
                >
          ...
          <div className="basis-1/2">
            <p className="text-2xl font-bold text-[#0B6653]">
              Hasil Perhitungan
            </p>
            ...
            <input
              type="text"
              className="w-full p-2 mb-4 border border-gray-300 bg-gray-200 rounded-md"
              value={`${kebutuhanBanyakKarung} karung`}
              readOnly
            />
            ...
            <input
              type="text"
              className="w-full p-2 mb-4 border border-gray-300 bg-gray-200 rounded-md"
              value={formatRupiah(prakiraanBiaya)}
              readOnly
            />
